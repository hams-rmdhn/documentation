...
<Stepper>
  ...
  <StepperItem title="Step 3: Activate">
    ...
    ![Activate Dynamic Data](https://si-plugins.b-cdn.net/plugins/dynamic-data/assets/install-dynamic-data.png)
  </StepperItem>
</Stepper>
...
<Stepper>
  ...
  <StepperItem title="Step 2: Update Now">
    ...
    ![Update Dynamic Data](https://si-plugins.b-cdn.net/plugins/dynamic-data/assets/update-dynamic-data.png)
  </StepperItem>
  </StepperItem>
</Stepper>
